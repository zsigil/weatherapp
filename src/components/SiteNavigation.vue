    ...
    >
      <RouterLink :to="{ name: 'home' }">
        <div class="flex items-center gap-3">
          ...
          <p class="text-2xl">Covid data per country</p>
        </div>
      </RouterLink>
...
const addCountry = () => {
  ...
  savedCountries.value.push(locationObj);
  localStorage.setItem("savedCountries", JSON.stringify(savedCountries.value));
